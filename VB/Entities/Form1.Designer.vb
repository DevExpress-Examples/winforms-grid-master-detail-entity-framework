...
'			Me.gridView1.MasterRowEmpty += New DevExpress.XtraGrid.Views.Grid.MasterRowEmptyEventHandler(Me.OnMasterRowEmpty);
'			Me.gridView1.MasterRowGetChildList += New DevExpress.XtraGrid.Views.Grid.MasterRowGetChildListEventHandler(Me.OnMasterRowGetChildList);
'			Me.gridView1.MasterRowGetRelationName += New DevExpress.XtraGrid.Views.Grid.MasterRowGetRelationNameEventHandler(Me.OnMasterRowGetRelationName);
'			Me.gridView1.MasterRowGetRelationCount += New DevExpress.XtraGrid.Views.Grid.MasterRowGetRelationCountEventHandler(Me.OnMasterRowGetRelationCount);
			' 
			' defaultLookAndFeel1
			' 
