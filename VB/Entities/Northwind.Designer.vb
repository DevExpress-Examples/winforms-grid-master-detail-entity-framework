...
Namespace DXSample
    ...
    Public Partial Class NorthwindEntities
        ...
        ''' </summary>
        Public ReadOnly Property Products As Global.System.Data.Objects.ObjectQuery(Of DXSample.Product)
            Get
                If(Me._Products Is Nothing) Then
                    Me._Products = Me.CreateQuery(Of DXSample.Product)("[Products]")
                End If
        ...
        Private _Products As Global.System.Data.Objects.ObjectQuery(Of DXSample.Product)

        ''' <summary>
        ''' There are no comments for Orders in the schema.
        ''' </summary>
        Public ReadOnly Property Orders As Global.System.Data.Objects.ObjectQuery(Of DXSample.Order)
            Get
                If(Me._Orders Is Nothing) Then
                    Me._Orders = Me.CreateQuery(Of DXSample.Order)("[Orders]")
                End If
        ...
        Private _Orders As Global.System.Data.Objects.ObjectQuery(Of DXSample.Order)

        ''' <summary>
        ''' There are no comments for Order_Details in the schema.
        ''' </summary>
        Public ReadOnly Property Order_Details As Global.System.Data.Objects.ObjectQuery(Of DXSample.Order_Detail)
            Get
                If(Me._Order_Details Is Nothing) Then
                    Me._Order_Details = Me.CreateQuery(Of DXSample.Order_Detail)("[Order_Details]")
                End If
        ...
        Private _Order_Details As Global.System.Data.Objects.ObjectQuery(Of DXSample.Order_Detail)

        ''' <summary>
        ''' There are no comments for Products in the schema.
        ''' </summary>
        Public Sub AddToProducts(ByVal product As DXSample.Product)
        ...
        ''' There are no comments for Orders in the schema.
        ''' </summary>
        Public Sub AddToOrders(ByVal order As DXSample.Order)
        ...
        ''' There are no comments for Order_Details in the schema.
        ''' </summary>
        Public Sub AddToOrder_Details(ByVal order_Detail As DXSample.Order_Detail)
    ...
    Public Partial Class Product
        ...
        Public Shared Function CreateProduct(ByVal productID As Integer, ByVal productName As String, ByVal discontinued As Boolean) As Product
            Dim product As DXSample.Product = New DXSample.Product()
        ...
        <Global.System.Runtime.Serialization.DataMemberAttribute()>
        Public Property Order_Details As Global.System.Data.Objects.DataClasses.EntityCollection(Of DXSample.Order_Detail)
            Get
                Return CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.GetRelatedCollection(Of DXSample.Order_Detail)("NorthwindModel.FK_Order_Details_Products", "Order_Detail")
            End Get

            Set(ByVal value As Global.System.Data.Objects.DataClasses.EntityCollection(Of DXSample.Order_Detail))
                If(value IsNot Nothing) Then
                    CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.InitializeRelatedCollection(Of DXSample.Order_Detail)("NorthwindModel.FK_Order_Details_Products", "Order_Detail", value)
                End If
            End Set
        End Property
    End Class
    ...
    Public Partial Class Order
        ...
        Public Shared Function CreateOrder(ByVal orderID As Integer) As Order
            Dim order As DXSample.Order = New DXSample.Order()
        ...
        Public Property Order_Details As Global.System.Data.Objects.DataClasses.EntityCollection(Of DXSample.Order_Detail)
            Get
                Return CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.GetRelatedCollection(Of DXSample.Order_Detail)("NorthwindModel.FK_Order_Details_Orders", "Order_Detail")
            End Get

            Set(ByVal value As Global.System.Data.Objects.DataClasses.EntityCollection(Of DXSample.Order_Detail))
                If(value IsNot Nothing) Then
                    CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.InitializeRelatedCollection(Of DXSample.Order_Detail)("NorthwindModel.FK_Order_Details_Orders", "Order_Detail", value)
                End If
            End Set
        End Property
    End Class
    ...
    Public Partial Class Order_Detail
        ...
        Public Shared Function CreateOrder_Detail(ByVal orderID As Integer, ByVal productID As Integer, ByVal unitPrice As Decimal, ByVal quantity As Short, ByVal discount As Single) As Order_Detail
            Dim order_Detail As DXSample.Order_Detail = New DXSample.Order_Detail()
        ...
        Public Property Order As Order
            Get
                Return CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of DXSample.Order)(CStr(("NorthwindModel.FK_Order_Details_Orders")), CStr(("Order"))).Value
            End Get

            Set(ByVal value As Order)
                CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of DXSample.Order)(CStr(("NorthwindModel.FK_Order_Details_Orders")), CStr(("Order"))).Value = value
            End Set
        End Property
        ...
        <Global.System.Runtime.Serialization.DataMemberAttribute()>
        Public Property OrderReference As Global.System.Data.Objects.DataClasses.EntityReference(Of DXSample.Order)
            Get
                Return CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of DXSample.Order)("NorthwindModel.FK_Order_Details_Orders", "Order")
            End Get

            Set(ByVal value As Global.System.Data.Objects.DataClasses.EntityReference(Of DXSample.Order))
                If(value IsNot Nothing) Then
                    CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.InitializeRelatedReference(Of DXSample.Order)("NorthwindModel.FK_Order_Details_Orders", "Order", value)
                End If
            End Set
        End Property
        ...
        Public Property Product As Product
            Get
                Return CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of DXSample.Product)(CStr(("NorthwindModel.FK_Order_Details_Products")), CStr(("Product"))).Value
            End Get

            Set(ByVal value As Product)
                CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of DXSample.Product)(CStr(("NorthwindModel.FK_Order_Details_Products")), CStr(("Product"))).Value = value
            End Set
        End Property
        ...
        <Global.System.ComponentModel.BrowsableAttribute(False)>
        <Global.System.Runtime.Serialization.DataMemberAttribute()>
        Public Property ProductReference As Global.System.Data.Objects.DataClasses.EntityReference(Of DXSample.Product)
            Get
                Return CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of DXSample.Product)("NorthwindModel.FK_Order_Details_Products", "Product")
            End Get

            Set(ByVal value As Global.System.Data.Objects.DataClasses.EntityReference(Of DXSample.Product))
                If(value IsNot Nothing) Then
                    CType((Me), Global.System.Data.Objects.DataClasses.IEntityWithRelationships).RelationshipManager.InitializeRelatedReference(Of DXSample.Product)("NorthwindModel.FK_Order_Details_Products", "Product", value)
                End If
            End Set
        End Property
    End Class
